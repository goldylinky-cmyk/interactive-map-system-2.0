...
iconData.forEach(icon => {
    ...
    // keep inside map container
    function positionTooltip() {
  
        const iconLeft = parseFloat(el.style.left);
        const iconTop = parseFloat(el.style.top);
        const iconWidth = el.offsetWidth;
        const containerWidth = mapContainer.offsetWidth;
        const containerHeight = mapContainer.offsetHeight;
        const iconCenterX = (iconLeft / 100) * containerWidth + (iconWidth / 2);
        const iconTopY = (iconTop / 100) * containerHeight;
        const tooltipLeftPercent = (iconCenterX / containerWidth) * 100;
        const tooltipTopPercent = (iconTopY / containerHeight) * 100;
        tooltip.style.left = `${tooltipLeftPercent}%`;
        tooltip.style.top = `${tooltipTopPercent}%`;
    }
...
const hoursMap = {
  ...
  "CEIT Faculty Room": { open: "08:00", close: "17:00" },
  "CEIT Chairperson Room": { open: "08:00", close: "17:00" },
  "Mikrotik Academy": { open: "07:00", close: "19:00" },
  "CEIT Equipment Room": { open: "08:00", close: "17:00" },
  "Electronic and Circuits Laboratory": { open: "07:00", close: "17:00" },
  "CEIT Lecture Room": { open: "07:00", close: "16:00" },
  "Drawing Laboratory": { open: "07:00", close: "17:00" },
  "Mac Laboratory": { open: "07:00", close: "17:00" },
  "CEIT Computer Laboratory": { open: "07:00", close: "16:00" },
  "Storage Room": { open: "08:00", close: "16:00" },
  "CBA Faculty Room": { open: "08:00", close: "16:00" },
  "CBA Chairperson Room": { open: "08:00", close: "16:00" },
  ...
  "Business Stimulation Office": { open: "07:00", close: "16:00" },
  "Conference Room": { open: "07:00", close: "16:00" },
  "Learning Resource Center": { open: "07:00", close: "16:30" },
  "Computer Laboratory": { open: "07:00", close: "16:00" },
  "Prefect of Student Formation and Activities": { open: "08:00", close: "16:00" },
  "CON Faculty Room": { open: "08:00", close: "16:00" },
  "CON Chairperson Room": { open: "08:00", close: "16:00" },
  ...
  "Student Affairs and Activities": { open: "08:00", close: "16:00" },
  "COE Faculty Room": { open: "08:00", close: "16:00" },
  "COE Chairperson Room": { open: "08:00", close: "16:00" },
  ...
  "Faculty Room": { open: "08:00", close: "17:00" },
  "Computer Laboratory - Kinder": { open: "07:00", close: "15:00" },
  "Mother Francisca Outreach Center": { open: "08:00", close: "17:00" },
  "Sewing Center": { open: "08:00", close: "17:00" },
  "Casa Sebastiana": { open: "08:00", close: "17:00" },
  ...
  "Play Room": { open: "07:00", close: "15:00" },

  // === St. Catherine Building ===
  "Casa Antonia-Training Hotel": { open: "07:00", close: "17:00" },
  "Nutrition Laboratory 1": { open: "07:00", close: "17:00" },
  "Sewing Room": { open: "07:00", close: "17:00" },
  "Wellness Room": { open: "07:00", close: "17:00" },
  "Nutrition Laboratory 2": { open: "07:00", close: "17:00" },
  "SCB201": { open: "07:00", close: "15:00" },
  "SCB202": { open: "07:00", close: "15:00" },
  "SCB203": { open: "07:00", close: "15:00" },
  "SCB204": { open: "07:00", close: "15:00" },
  "SCB205": { open: "07:00", close: "15:00" },
  "SCB206": { open: "07:00", close: "16:00" },
  "SCB207": { open: "07:00", close: "15:00" },
  "SCB208": { open: "07:00", close: "15:00" },
  "SCB209": { open: "07:00", close: "15:00" },
  "SCB210": { open: "07:00", close: "15:00" },
  "Grade School Prefect of Student Formation and Grade Level Leader": { open: "08:00", close: "15:00" },
  "SCB301": { open: "07:00", close: "15:00" },
  "SCB302": { open: "07:00", close: "15:00" },
  "SCB303": { open: "07:00", close: "15:00" },
  "SCB304": { open: "07:00", close: "15:00" },
  "SCB305": { open: "07:00", close: "15:00" },
  "SCB306": { open: "07:00", close: "15:00" },
  "SCB307": { open: "07:00", close: "15:00" },
  "SCB308": { open: "07:00", close: "15:00" },
  "SCB309": { open: "07:00", close: "15:00" },
  "Mimeographing Room": { open: "08:00", close: "17:00" },
  "SCB401": { open: "07:00", close: "15:00" },
  "SCB402": { open: "07:00", close: "15:00" },
  "SCB403": { open: "07:00", close: "15:00" },
  "SCB404": { open: "07:00", close: "15:00" },
  "SCB405": { open: "07:00", close: "15:00" },
  "Math Faculty": { open: "08:00", close: "16:00" },
  "Principal's Office": { open: "08:00", close: "17:00" },
  "SCB501": { open: "07:00", close: "15:00" },
  "SCB502": { open: "07:00", close: "15:00" },
  "SCB503": { open: "07:00", close: "15:00" },
  "SCB504": { open: "07:00", close: "15:00" },
  "SCB505": { open: "07:00", close: "15:00" },
  "SCB506": { open: "07:00", close: "15:00" },
  "Auditorium": { open: "07:30", close: "19:00" },

  // === St. Dominic Building ===
  "Dominic Canteen": { open: "07:00", close: "17:00" },
  "Mikrotik Training Center": { open: "07:00", close: "17:00" },
  "IBED Student Council Office": { open: "8:00", close: "17:00" },
  "SCT Assessment Center": { open: "08:00", close: "17:00" },
  "SCT Archives": { open: "08:00", close: "17:00" },
  "St. Rose of Lima Hall": { open: "07:00", close: "17:00" },
  "Comp Lab Office": { open: "08:00", close: "17:00" },
  "College Comp Lab": { open: "08:00", close: "16:00" },
  "Accreditation Center": { open: "08:00", close: "17:00" },
  "HS Comp Lab": { open: "07:00", close: "16:00" },
  "Office of the President": { open: "08:00", close: "17:00" },
  "Cyber Siena": { open: "08:00", close: "17:00" },
  "Finance Office": { open: "08:00", close: "17:00" },
  "Office of the Guidance Services": { open: "08:00", close: "17:00" },
  "Registrar's Office": { open: "08:00", close: "17:00" },
  "Admission and Marketing": { open: "08:00", close: "17:00" },
  "Catharsis Room": { open: "08:00", close: "17:00" },
  "Mindfulness Room": { open: "07:00", close: "17:00" },
  "Multipurpose Room": { open: "07:00", close: "17:00" },
  "Instructional Media Center Office": { open: "08:00", close: "17:00" },
  "GS LRC": { open: "07:00", close: "15:00" },
  "CL VE Faculty": { open: "08:00", close: "17:00" },
  "Safety and Disaster Risk Management Office": { open: "08:00", close: "17:00" },
  "SDB201": { open: "07:00", close: "16:00" },
  "SDB202": { open: "07:00", close: "16:00" },
  "SDB203": { open: "07:00", close: "16:00" },
  "Reverb Lab": { open: "07:00", close: "19:00" },
  "Music Room": { open: "07:00", close: "19:00" },
  "SDB311": { open: "07:00", close: "16:00" },
  "SDB312": { open: "07:00", close: "16:00" },
  "SDB313": { open: "07:00", close: "16:00" },
  "SDB314": { open: "07:00", close: "16:00" },
  "SDB315": { open: "07:00", close: "16:00" },
  "SDB316": { open: "07:00", close: "16:00" },
  "SDB317": { open: "07:00", close: "16:00" },
  "Exhibit Room": { open: "07:00", close: "17:00" },
  "SDB318": { open: "07:00", close: "16:00" },
  "SDB320": { open: "07:00", close: "18:00" },
  "SDB321": { open: "07:00", close: "18:00" }, 
  "SDB322": { open: "07:00", close: "18:00" },
  "SDB323": { open: "07:00", close: "18:00" }, 
  "Science Laboratory Office": { open: "08:00", close: "17:00" },
  "Reading Faculty": { open: "08:00", close: "17:00" },
  "AP and Filipino Faculty": { open: "08:00", close: "17:00" },
  "English Faculty": { open: "08:00", close: "17:00" },
  "MAPEH Faculty": { open: "08:00", close: "17:00" },
  "Science Faculty": { open: "08:00", close: "17:00" },
  "TLE/ICT Area": { open: "07:00", close: "16:00" },
  "SHS Year Level Leader": { open: "07:00", close: "16:00" },
  "SHS Prefect of Formation": { open: "07:00", close: "16:00" },
  "SDB401": { open: "07:00", close: "16:00" },
  "SDB402": { open: "07:00", close: "16:00" },
  "SDB403": { open: "07:00", close: "16:00" },
  "SDB404": { open: "07:00", close: "16:00" },
  "SDB405": { open: "07:00", close: "16 :00" },
  "SDB406": { open: "07:00", close: "16:00" },
  "SDB407": { open: "07:00", close: "16:00" },
  "SDB408": { open: "07:00", close: "16:00" },
  "SDB409": { open: "07:00", close: "16:00" },
  "SDB410": { open: "07:00", close: "16:00" },
  "SDB411": { open: "07:00", close: "16:00" },
  "SDB412": { open: "07:00", close: "16:00" },
  "SDB413": { open: "07:00", close: "16:00" },
  "SDB414": { open: "07:00", close: "16:00" },
  "SDB415": { open: "07:00", close: "16:00" },
  "Publication Office": { open: "07:00", close: "16:00" },
  "High School Prefect of Student Formation Office": { open: "08:00", close: "17:00" },
  "JLL": { open: "08:00", close: "17:00" },
  "SDB501": { open: "07:00", close: "16:00" },
  "SDB502": { open: "07:00", close: "16:00" },
  "SDB503": { open: "07:00", close: "16:00" },
  "SDB504": { open: "07:00", close: "16:00" },
  "SDB505": { open: "07:00", close: "16:00" },
  "SDB506": { open: "07:00", close: "16:00" },
  "SDB507": { open: "07:00", close: "16:00" },
  "SDB511": { open: "07:00", close: "16:00" },
  "SDB512": { open: "07:00", close: "16:00" },
  "SDB513": { open: "07:00", close: "16:00" },
  "SDB514": { open: "07:00", close: "16:00" },

  // === St. Jacques Building ===
  "CIHM Faculty Office": { open: "08:00", close: "17:00" },
  "CIHM Chairperson Office": { open: "08:00", close: "17:00" },
  "Practicum Office": { open: "08:00", close: "17:00" },
  ...
  "General Store Room": { open: "08:00", close: "17:00" },
  "General Stock Room": { open: "08:00", close: "17:00" },
  "Linen Room 1": { open: "08:00", close: "17:00" },
  "Mistress Room": { open: "08:00", close: "17:00" },
  "Laundry Area (Personnel Only)": { open: "08:00", close: "17:00" },
  ...
  "Office of the Principal and Subject Area Coordinators": { open: "08:00", close: "17:00" },
  "Office of the Dean": { open: "08:00", close: "17:00" },
  "Office of the NSTP Coordinator": { open: "08:00", close: "17:00" },
